...
rech0 <- import("2017/Modulo64/RECH0.SAV" %>% paste0(endesdir,.), setclass = "data.table")
## Respondent basic data
rec0111 <- import("2017/Modulo66/REC0111.SAV" %>% paste0(endesdir,.), setclass = "data.table")
## Reproduction/Contraception
rec21 <- import("2017/Modulo67/REC21.SAV" %>% paste0(endesdir,.), setclass = "data.table")
re223132 <- import("2017/Modulo67/RE223132.SAV" %>% paste0(endesdir,.), setclass = "data.table")
re516171 <- import("2017/Modulo71/RE516171.SAV" %>% paste0(endesdir,.), setclass = "data.table")
re758081 <- import("2017/Modulo72/RE758081.SAV" %>% paste0(endesdir,.), setclass = "data.table")
## Cuestionario de Salud
csalud01 <- data.table(haven::read_sav("2017/Modulo414/CSALUD01.sav" %>% paste0(endesdir,.), encoding = "latin1"))
## Cuestionario de Salud (<12a)
csalud08 <- data.table(haven::read_sav("2017/Modulo414/CSALUD08.sav" %>% paste0(endesdir,.), encoding = "latin1"))
## Anemia mujer
rec42 <- import("2017/Modulo70/REC42.SAV" %>% paste0(endesdir,.), setclass = "data.table")
## Mortalidad materna
rec83 <- import("2017/Modulo73/REC83.SAV" %>% paste0(endesdir,.), setclass = "data.table")
## Violencia domestica
rec84dv <- import("2017/Modulo73/REC84DV.SAV" %>% paste0(endesdir,.), setclass = "data.table")
...
cbind(indnom,
      ...
      fuente = "ENDES 2017") %>% list(content=., comments=comments) -> out.endes
